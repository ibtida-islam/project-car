...
const CheckoutForm = ({ amount }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // console.log("Received clientSecret:", clientSecret); // Log clientSecret
    const { clientSecret, error } = await response.json();
console.log("Received clientSecret:", clientSecret);
console.log("Error:", error);

    if (!clientSecret) {
      setPaymentMessage("Missing client secret from the backend");
...
const PaymentAmountForm = ({ onAmountSubmit }) => {
  ...
  return (
    <form className="payment-form" onSubmit={handleSubmitAmount}>
      <input
        type="number"
        value={amount}
...
//     const { clientSecret } = await response.json();
//     // Log the clientSecret to check if it's correctly received
//     console.log("Received clientSecret:", clientSecret);
